...
class ZoneServiceImpl(val extole: ExtoleInternal) :
    ...
    val programDomain: String = extole.programDomain()
    val logger: ExtoleLogger = extole.logger()
    ...
    private fun getZone(
        ...
        val zonesApi = ZonesEndpoints(programDomain, extole.accessToken(), extole.getHeaders())
