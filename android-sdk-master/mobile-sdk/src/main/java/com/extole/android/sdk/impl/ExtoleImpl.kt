...
class ExtoleImpl(
    ...
    override fun logger(): ExtoleLogger {
        return logger
    }

    override fun context(): ApplicationContext = context
    ...
    override suspend fun sendEvent(
        ...
        try {
            ...
            val httpPostResult = extoleServices.eventsEndpoints().post(requestBody)
    ...
    override fun logger(logger: ExtoleLogger) {
        this.logger = logger
    }

    override fun fetchServices(): ExtoleServices {
    ...
    override fun data(): MutableMap<String, String> {
        return appData
    }

    override fun programDomain() = programDomain

    override fun accessToken() = accessToken

    override fun zonesResponse() = zonesResponse

    override fun operations() = operations

    override fun jsonConfiguration(): MutableList<JSONObject> {
        return configuration
    }

    override fun disabledActions(): Set<Action.ActionType> {
